...
| `bonuses` | [PlayerRatingBonuses!](../objects/PlayerRatingBonuses) | Breakdown of bonuses and penalties that contributed to the final rating. |
...
| `ratingHistory` | [[PlayerRatingMinute!]!](../objects/PlayerRatingMinute) | Historical rating data for player throughout the match, sorted by minute in ascending order. |
