...
Multiple queries are available to retrieve aggregated metrics for teams and players, with different levels of granularity and not all of thema are available at the moment. We will be adding more queries in the future to cover more types of aggregated metrics.
